...
def generate_file_actions(self, mod: Module, output: str):
	...
	for ep in mod.endpoints.values():
		...
		if ep.return_type:
			...
			if return_type_lower not in ["str", "string", "text", "int", "num", "number", "float", "double",
			                              "bool", "boolean", "check", "checkbox", "date", "datetime",
			                              "file", "upload", "json", "obj", "object"]:
	...
	custom_actions_header_snippet = self.snippets.get("actions", "\n// Add custom imports here\n")
